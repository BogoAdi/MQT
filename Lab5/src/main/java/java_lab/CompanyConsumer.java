...
public class CompanyConsumer {
    ...
    public static void main(String[] args) {
        ...
        props.put(ConsumerConfig.VALUE_DESERIALIZER_CLASS_CONFIG, KafkaJsonSerializer.class.getName());
        props.put(KafkaJsonSchemaDeserializerConfig.JSON_VALUE_TYPE, Company.class.getName());
