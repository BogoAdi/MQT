...
public class SimpleExampleProducer {
  ...
  // private static final String OUR_BOOTSTRAP_SERVERS = "localhost:9092, localhost:9093, localhost:9094";
    ...
    public static void main(String[] args){
        ...
        ProducerRecord<String, String> data3 = new ProducerRecord<>("events2", "wow", "Hello!");

        ProducerRecord<String, String> data4 = new ProducerRecord<>("events2", "wow", "bye!");
        ...
        try {
            RecordMetadata meta = producer.send(data4).get();
